...
import { Mail, MessageCircle, Calendar, ArrowRight, Loader2, Link2 } from "lucide-react";
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Joseph Kamau" className="bg-surface" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="jerome@example.com" type="email" className="bg-surface" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
