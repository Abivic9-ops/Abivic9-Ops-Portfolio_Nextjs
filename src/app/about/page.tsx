...
const EDUCATION = [
  ...
  },
  {
    ...
    school: "ALX Africa",
    year: "2023 — 2024",
    focus: "Full-stack engineering, system design, DevOps, and professional soft skills",
  },
];
...
const FAQS = [
  {
    ...
    a: "I focus on full-stack SaaS applications, fintech integrations (M-PESA, Africa's Talking), AI-powered platforms, and system architecture consulting. I work best on projects where I can own the full lifecycle from strategy to deployment.",
  },
  {
    q: "How do you handle timelines and communication?",
    a: "Weekly progress updates, transparent milestone tracking, and a shared project board. You never have to chase me for updates — I communicate proactively, especially when something shifts.",
  },
  {
    q: "Can you work with my existing team?",
    a: "Absolutely. I integrate into your existing workflows, whether that's your Git workflow, sprint cadence, or communication tools. I'm as comfortable working independently as I am embedded in a team.",
  },
  {
...
const EXPERTISE_AREAS = [
  {
    ...
    items: [
      ...
      "Production-grade code quality with scalability as default",
      ...
      "Security-first development practices and automated testing pipelines",
  ...
  },
  {
    ...
    items: [
      ...
      "ROI-focused technology recommendations — not just what's new, but what's right",
    ],
  },
  {
    ...
    icon: Shield,
    items: [
      "On-time, budget-conscious project delivery with clear milestones",
      "Adaptability to shifting requirements without scope creep",
      "Documentation that lasts beyond the project lifecycle",
      "Knowledge transfer to your internal teams for long-term ownership",
  ...
  },
  {
    ...
    items: [
      ...
      "Time-to-market acceleration without sacrificing quality",
  ...
  },
  {
    ...
    icon: HeartHandshake,
    items: [
      "Cross-functional communication that includes non-technical stakeholders",
  ...
  },
  {
    ...
    items: [
      ...
      "Security audits, performance benchmarks, and cross-browser testing",
      "Post-launch support and monitoring setup for peace of mind",
...
const CREDIBILITY_PROOFS = [
  { stat: "40+", label: "Projects Delivered", desc: "Across fintech, SaaS, and developer tooling" },
  { stat: "15+", label: "Clients Served", desc: "From startups to established businesses" },
  { stat: "6+", label: "Years Experience", desc: "Building production systems end-to-end" },
  ...
  return (
    <div className="min-h-screen">
          ...
          >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/projects" className={cn(buttonVariants(), "rounded-full bg-primary text-primary-foreground hover:bg-primary/90 group")}>
                  View My Work <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
                </Link>
                <a href={`mailto:${SITE.email}`} className={cn(buttonVariants({ variant: "outline" }), "rounded-full border-border")}>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Who I Am</h2>
            </div>
            <div className="h-0.5 w-10 bg-primary rounded-full mb-8" />
            <div className="space-y-5 text-muted-foreground leading-relaxed max-w-3xl">
              <p className="text-lg">
                I&apos;m a senior full-stack engineer based in Kenya with over 6 years of experience shipping production-grade
                software. I specialize in building SaaS platforms, fintech integrations — including M-PESA Daraja and
                Africa&apos;s Talking — and AI-powered solutions that deliver measurable outcomes.
              </p>
              <p className="text-lg">
      ...
      <section className="py-20 md:py-28 border-t border-border/50 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[radial-gradient(ellipse_at_center,_rgba(34,211,117,0.04),_transparent_60%)]" />
        </div>
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">How I Work</h2>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute left-[23px] top-0 bottom-0 w-px bg-gradient-to-b from-primary/30 via-primary/10 to-transparent hidden md:block" />
            ...
            <div className="space-y-12 md:space-y-16">
              {HOW_I_WORK.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Step number badge */}
                    <div className="hidden md:flex absolute left-0 top-0 w-12 h-12 rounded-full bg-primary/10 border border-primary/20 items-center justify-center text-primary font-bold text-lg">
                      {step.step}
                    </div>
                    <div className="bg-surface/30 border border-border/60 rounded-2xl p-6 md:p-8 hover:border-primary/20 transition-colors">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="md:hidden w-10 h-10 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-primary font-bold shrink-0">
                          {step.step}
                        </div>
                        <Icon className="w-5 h-5 text-primary hidden md:block" />
                        <h3 className="text-xl font-semibold text-foreground">{step.title}</h3>
                      </div>
                      <p className="text-muted-foreground leading-relaxed pl-0 md:pl-0">
                        {step.desc}
                      </p>
                    </div>
                  </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Education & Learning</h2>
            </div>
            <div className="h-0.5 w-10 bg-primary rounded-full mb-10" />
          </motion.div>
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Proof of Outcomes</h2>
            </div>
            <div className="h-0.5 w-10 bg-primary rounded-full mb-8" />
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Technical Expertise & Capabilities</h2>
            </div>
            <div className="h-0.5 w-10 bg-primary rounded-full" />
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Fit, Scope & Who I Work With</h2>
            </div>
            <div className="h-0.5 w-10 bg-primary rounded-full mb-10" />
          </motion.div>
            ...
            <div className="bg-surface/30 border border-border/60 rounded-2xl p-6 md:p-8">
              ...
              <ul className="space-y-2.5 text-muted-foreground text-sm leading-relaxed">
                {[
                  ...
                  "Agencies needing a senior engineering partner for complex client projects",
      ...
      <section className="py-20 md:py-28 border-t border-border/50 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(ellipse_at_center,_rgba(34,211,117,0.08),_transparent_60%)]" />
        </div>
